...
describe('Comments', () => {
  describe('RENDERING', () => {
    ...
    it('renders comment-form if user is logged in', () => {
      ...
      expect(wrapper.find('.comments').children().last())
        .toHaveClassName('comment-form')
    })
    ...
    it('does not render comment-form if user is not logged in', () => {
      ...
      expect(wrapper.find('.comments').children().last())
        .not.toHaveClassName('comment-form')
    })
  })
  ...
  describe('INTERACTION', () => {
    describe('submitting comment form', () => {
      ...
      it('should call addComment', () => {
        expect(minProps.addComment).toBeCalledWith(
          minProps.id, '', ''
        )
      })
    ...
    describe('clicking remove button', () => {
      ...
      it('should call removeComment', () => {
        expect(minProps.removeComment).toBeCalledWith(
          'commentId', minProps.id
        )
      })
